...
const TradeCard = ({ trade , onClick }) => {
  ...
  return (
      <div onClick={onClick} className="mt-3 rounded-2xl border border-white/10 bg-[#1b1b1b] p-4 shadow-sm shadow-black/30">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="text-right">
            <p
              className={`text-[1.6rem] font-semibold leading-none ${pnlColor}`}
            >
              {trade.status === "closed"
